...
srun torchexec bash -c "export HOME=/work1/cms_mlsim/oamram/CaloDiffusion/; timeout 7.8h python3 -m calodiffusion.training --config CONFIG --data_folder /wclustre/cms_mlsim/denoise/CaloChallenge/ --checkpoint CHECKPOINT --load --reset_training EXTRAARGS MODELTYPE"
else 
srun torchexec bash -c "export HOME=/work1/cms_mlsim/oamram/CaloDiffusion/; timeout 7.8h python3 -m calodiffusion.training --config CONFIG --data_folder /wclustre/cms_mlsim/denoise/CaloChallenge/ --checkpoint CHECKPOINT --load EXTRAARGS MODELTYPE"
fi
